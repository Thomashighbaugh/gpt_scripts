...
for chunk in g4f.ChatCompletion.create(
    ...
    messages=[{"role": "user", "content": f"Refactor for performance and modularity, comprehensively document using ldoc format and generally improve the AwesomeWM Lua code in this file:\n```lua\n{lua_code}\n```"}], 
    timeout=300,
    stream=True,
):
